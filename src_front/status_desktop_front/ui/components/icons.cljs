...
(def icons {:icons/chats               (js/require "./resources/icons/bottom/chats_gray.svg")
            ...
            :icons/home                (js/require "./resources/icons/home_gray.svg")
            :icons/home-active         (js/require "./resources/icons/home_blue.svg")
            :icons/profile             (js/require "./resources/icons/profile_gray.svg")
            :icons/profile-active      (js/require "./resources/icons/profile_blue.svg")})
